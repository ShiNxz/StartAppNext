...
const ColoredBox = ({ style }) => {
    ...
    return (
        <div className={`inline-block relative overflow-hidden rounded-md text-white p-6 h-fit bg-gradient-to-br ${style} w-full shadow-xl`}>
            <span className='block drop-shadow-lg relative'>צפיות בעמוד</span>
            <span className='block text-left my-1 text-2xl tracking-widest drop-shadow-lg relative'>50.000</span>
